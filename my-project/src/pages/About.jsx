...
const About = () => {
  ...
  return (
    ...
    <main className=' pt-28 px-5 sm:px-1 justify-between items-center w-full max-h-full md:max-w-[1240px] mx-auto mb-10' >
            <div className=' md:flex  ' data-AOS="fade-up" >
              <img src={together} alt= "bgimage" className='bg-transparent'  data-aos="fade-up"/>
              <div className='  sm:pt-20 justify-between items-center w-full max-h-full md:max-w-[1240px] mx-auto  '>
                <h1 className='font-medium md:font-bold text-5xl md:text-7xl text-blue-600 py-2' data-aos="fade-up" >Fort Worth Africa Funeral Foundation</h1>
                <p className='text-lg md:text-3xl md:pt-10' data-aos="fade-up" > Our mission here is to provide guidance to our community, Support in any situation, Personal growth, educational etc... Which is crucial to adapt in this country. And that is what FWAYG want to provide for our community</p>
              </div>
              
            </div>
            
      <section className=' text-justify  px-5 md:sm:px-40 max-h-max pt-5 ' data-aos="fade-up" >
        <h2 className='font-bold   text-3xl py-2 text-[#000000] ' data-aos="fade-up" >FWAFF Concept</h2>
        <p className='text-lg  md:text-xl' data-aos="fade-up" > We have seen how people come to America and loose they are way in the process. Which I myself is one of them. And that is one of the thing that we will mostly focus about, helping others by :<br />
        ...
        The problem that we face now in our community is luck of information and guidance and that’s what <span className='text-blue-400'> FWAFF</span> is bring to our community. 
        ...
        <article className=' ' >
          ...
          <div className='grid sm:grid-cols-2 md:grid-cols-3 gap-5 sm:gap-1  mx-auto max-w-[1240px]'>
