...
const About = () => {
  return (
    <div  className='flex px-5  pt-20   justify-between items-center w-full h-full md:max-w-[1240px] m-auto'>
      <div className=' text-justify bg-slate-100 rounded-md p-5 md:sm:px-60 ' >
        ...
        <h2 className='font-light  text-lg py-2 text-blue-700'>FWAFF Concept</h2>
        ...
        <h2 className='font-light   text-lg py-2 text-blue-700 '>FWAFF’s long term mission</h2>
        <p> 
        ...
        <h2 className='font-light   text-xl py-2 text-blue-700'>Opportunities</h2>
        <p >
